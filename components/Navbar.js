...
const Navbar = () => {
  ...
  >
    <div className='p-4 flex justify-between items-center rounded-full w-4/5 mx-auto sm:shadow-sm sm:shadow-black sm:bg-[#2ff9c6] '>
        <h2 className='font-extrabold  text-lg text-black '> <Link href="/">Home</Link></h2>
